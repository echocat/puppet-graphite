...
class graphite::params {
  ...
  $graphitepkgs = $::osfamily ? {
    ...
    redhat => ["pycairo", "Django14", "python-ldap", "python-memcached", "python-sqlite2",  "bitmap", "bitmap-fonts-compat", "python-devel", "python-crypto", "pyOpenSSL", "gcc", "python-zope-filesystem", "python-zope-interface",  "gcc-c++", "zlib-static", "MySQL-python","python-txamqp"],
  }
